...
python3 agent-skill/organize-dispute-materials/scripts/package_skill.py \
  ...
  --output output/organize-dispute-materials-v6.6.0.zip --json
unzip -t output/organize-dispute-materials-v6.6.0.zip
```
